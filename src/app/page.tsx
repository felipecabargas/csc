          ...
          <div className="grid md:grid-cols-2 gap-16 items-start">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <a
                  href="mailto:contact@cabargas.consulting"
                  className="flex items-center gap-3 text-blue-200 hover:text-white transition-colors"
                >
                  <Mail size={16} className="flex-shrink-0 opacity-0" />
                  <span className="text-sm">contact@cabargas.consulting</span>
                </a>
            ...
            <div>
              <form
                action="https://formsubmit.co/felipe.cabargas@gmail.com"
                method="POST"
                className="space-y-4"
              >
                {/* Disable captcha page redirect, send as plain email */}
                <input type="hidden" name="_captcha" value="false" />
                <input type="hidden" name="_subject" value="New message from cabargas.consulting" />
                <div>
